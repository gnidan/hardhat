...
//
// import { CustomEthersProvider } from "../src/internal/ethers-provider-wrapper";
//
// import { useEnvironment } from "./helpers";
//
// describe("Ethers provider wrapper", function () {
//   let realProvider: ethers.JsonRpcProvider;
//   let wrapper: CustomEthersProvider;
//
//   useEnvironment("hardhat-project");
//
//   beforeEach(function () {
//     realProvider = new ethers.JsonRpcProvider("http://127.0.0.1:8545");
//     wrapper = new CustomEthersProvider(this.env.network.provider);
//   });
//
